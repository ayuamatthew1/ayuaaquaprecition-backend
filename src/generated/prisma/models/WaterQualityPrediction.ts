...
// @ts-nocheck 
/*
 * This file exports the `WaterQualityPrediction` model and its related types.
 *
...
export type GetWaterQualityPredictionAggregateType<T extends WaterQualityPredictionAggregateArgs> = {
      [P in keyof T & keyof AggregateWaterQualityPrediction]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateWaterQualityPrediction[P]>
    : Prisma.GetScalarType<T[P], AggregateWaterQualityPrediction[P]>
}
...
export type GetWaterQualityPredictionGroupByPayload<T extends WaterQualityPredictionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<WaterQualityPredictionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof WaterQualityPredictionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], WaterQualityPredictionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], WaterQualityPredictionGroupByOutputType[P]>
      }
    >
  >
...
export type WaterQualityPredictionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<WaterQualityPredictionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface WaterQualityPredictionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['WaterQualityPrediction'], meta: { name: 'WaterQualityPrediction' } }
  /**
   ...
   * })
  **/
  count<T extends WaterQualityPredictionCountArgs>(
    args?: Prisma.Subset<T, WaterQualityPredictionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], WaterQualityPredictionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends WaterQualityPredictionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, WaterQualityPredictionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWaterQualityPredictionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
